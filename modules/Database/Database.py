...
class Database():
    ...
    query_insert_message = f"""INSERT INTO {message_table} (chat_id, node, user_message, bot_response, created_at_user_message, created_at_bot_response) VALUES (%s, %s, %s, %s, %s, %s)"""
